        ...
        <section class="auth-center">
            ...
            <form id="signupForm" novalidate method="POST" action="/signup">
                ...
                <div class="mb-3">
                    ...
                    <input id="password" name="password" class="form-control" type="password" minlength="8" placeholder="At least 8 characters" />
                    <!--     <div class="invalid-feedback">Password must be at least 8 characters.</div> -->
                </div>

                <div class="mb-3">
                    <label for="confirm" class="form-label">Confirm password</label>
                    <input id="confirm" name="confirm" class="form-control" type="password" minlength="8" placeholder="Repeat password" />
